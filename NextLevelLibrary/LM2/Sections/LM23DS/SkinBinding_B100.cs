...
namespace NextLevelLibrary.LM2
{
    ...
    public class SkinController
    {
        ...
        public SkinController(ChunkEntry skinningChunk)
        {
                    ...
                    case ChunkType.SkinMatrices:
                        ...
                        using (var reader = new FileReader(chunk.Data, true))
                        {
                            for (int m = 0; m < numBones; m++)
                            {
                                ...
                                Matrices.Add(boneHash, reader.ReadStruct<Matrix4x4>());
                            }
                        }
                        break;
        ...
        public void Write(ChunkEntry skinningChunk, ModelFormat.ModelInfo model)
        {
